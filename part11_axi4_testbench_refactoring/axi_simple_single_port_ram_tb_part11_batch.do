# AXI Simple Single Port RAM Testbench - Part11 Version
...
# Compilation
# =============================================================================
echo "=== Compiling AXI Simple Single Port RAM Testbench (Part11) ==="
...
# Compile testbench
echo "Compiling axi_simple_single_port_ram_tb_part11.sv..."
vlog -sv axi_simple_single_port_ram_tb_part11.sv
...
# Completion
# =============================================================================
echo "=== Part11 AXI Simple Single Port RAM Testbench Simulation Complete ==="
