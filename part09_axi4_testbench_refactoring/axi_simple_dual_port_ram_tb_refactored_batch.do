# ModelSim Batch Script for AXI Simple Dual Port RAM Refactored Testbench
...
echo "=== Compiling AXI Simple Dual Port RAM Refactored Testbench ==="

# Compile the dual port RAM module first (from part07)
vlog -work work ../part07_axi_simple_dual_port_ram/dual_port_ram.v
echo "dual_port_ram.v compilation completed"

# Compile the DUT (Device Under Test) - SystemVerilog file (from part07)
...
echo "axi_read_channel_control_module.svh compilation completed"

# 11. Logger package and module (required by testbench)
vlog -work work axi_logger_pkg.sv
echo "axi_logger_pkg.sv compilation completed"
vlog -work work axi_logger.sv
echo "axi_logger.sv compilation completed"

# 12. Main testbench (depends on all header files and modules)
vlog -work work axi_simple_dual_port_ram_tb_refactored.sv
echo "axi_simple_dual_port_ram_tb_refactored.sv compilation completed"
